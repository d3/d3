...
suite.addBatch({
  "treemap": {
    ...
    //   assert.deepEqual(t.nodes(require("../data/tree.json")).map(layout), [
    //     {id: "root", x: 0, y: 0, dx: 1000, dy: 1000},
    //     {id: "a", x: 0, y: 833, dx: 1000, dy: 167},
    //     {id: "b", x: 600, y: 0, dx: 400, dy: 833},
    //     {id: "c", x: 0, y: 0, dx: 600, dy: 833},
    //     {id: "ca", x: 0, y: 555, dx: 600, dy: 278},
    //     {id: "cb", x: 0, y: 0, dx: 600, dy: 555}
    //   ]);
    // },
    ...
    //   assert.deepEqual(t.nodes(require("../data/tree.json")).map(layout), [
    //     {id: "root", x: 0, y: 0, dx: 1000, dy: 1000},
    //     {id: "a", x: 0, y: 0, dx: 333, dy: 500},
    //     {id: "b", x: 333, y: 0, dx: 667, dy: 500},
    //     {id: "c", x: 0, y: 500, dx: 1000, dy: 500},
    //     {id: "ca", x: 0, y: 500, dx: 333, dy: 500},
    //     {id: "cb", x: 333, y: 500, dx: 667, dy: 500}
    //   ]);
    // },
    // "correctly positions zero-value nodes": function(treemap) {
    //   var t = treemap().size([1000, 1000]).sort(null);
    //   assert.deepEqual(t.nodes(require("../data/tree-zero.json")).map(layout), [
    //     {id: "root", x: 0, y: 0, dx: 1000, dy: 1000},
    //     {id: "a", x: 0, y: 833, dx: 1000, dy: 167},
    //     {id: "z", x: 1000, y: 0, dx: 0, dy: 833},
    //     {id: "b", x: 600, y: 0, dx: 400, dy: 833},
    //     {id: "c", x: 0, y: 0, dx: 600, dy: 833},
    //     {id: "ca", x: 0, y: 555, dx: 600, dy: 278},
    //     {id: "cb", x: 0, y: 0, dx: 600, dy: 555}
    //   ]);
    // },
    // "treats NaN values as zero": function(treemap) {
    //   var t = treemap().size([1000, 1000]).sort(null);
    //   assert.deepEqual(t.nodes(require("../data/tree-nan.json")).map(layout), [
    //     {id: "root", x: 0, y: 0, dx: 1000, dy: 1000},
    //     {id: "a", x: 0, y: 833, dx: 1000, dy: 167},
    //     {id: "z", x: 1000, y: 0, dx: 0, dy: 833},
    //     {id: "b", x: 600, y: 0, dx: 400, dy: 833},
    ...
    //   ]);
    // },
    // "if all siblings are empty, the parent node is empty": function(treemap) {
    //   var t = treemap().size([1000, 1000]).sort(null);
    //   assert.deepEqual(t.nodes(require("../data/tree-zero-siblings.json")).map(layout), [
    //     {id: "root", x: 0, y: 0, dx: 1000, dy: 1000},
    //     {id: "a", x: 667, y: 0, dx: 333, dy: 1000},
    //     {id: "b", x: 0, y: 0, dx: 667, dy: 1000},
    //     {id: "z", x: 0, y: 0, dx: 0, dy: 1000},
    //     {id: "za", x: 0, y: 0, dx: 0, dy: 1000},
    //     {id: "zb", x: 0, y: 0, dx: 0, dy: 1000}
    //   ]);
    // },
    "if all nodes are empty, the layout is empty": function(treemap) {
      var t = treemap().size([1000, 1000]).sort(null);
      assert.deepEqual(t.nodes(require("../data/tree-zero-all.json")).map(layout), [
        {id: "root", x: 0, y: 0, dx: 0, dy: 0},
        {id: "a", x: 0, y: 0, dx: 0, dy: 0},
        {id: "b", x: 0, y: 0, dx: 0, dy: 0},
        {id: "z", x: 0, y: 0, dx: 0, dy: 0},
        {id: "za", x: 0, y: 0, dx: 0, dy: 0},
        {id: "zb", x: 0, y: 0, dx: 0, dy: 0}
      ]);
    },
