...
suite.addBatch({
  "select(body)": {
    ...
    "sets multiple attributes as a map": function(body) {
      body.attr({
        width: null,
        height: null,
        left: "10",
      ...
      assert.equal(document.body.getAttribute("width"), "");
      assert.equal(document.body.getAttribute("height"), "");
      assert.equal(document.body.getAttribute("left"), "10");
      assert.equal(document.body.getAttribute("top"), "20");
    },
    "sets multiple attributes as a function that returns a map": function(body) {
      body.attr(function() {
        return {
          foo: "foo",
          bar: 42,
      ...
      assert.equal(document.body.getAttribute("foo"), "foo");
      assert.equal(document.body.getAttribute("bar"), "42");
      assert.equal(document.body.getAttribute("left"), "");
      assert.equal(document.body.getAttribute("top"), "");
    },
