d3 = function() {
  ...
  d3.behavior.zoom = function() {
    ...
    function zoom() {
      if (this instanceof d3.transition) {
        this.each(function() {
        ...
        this.on(mousedown, mousedowned).on(d3_behavior_zoomWheel + ".zoom", mousewheeled).on(mousemove, mousewheelreset).on("dblclick.zoom", dblclicked).on(touchstart, touchstarted).each(function() {
          if (view !== this.__chart__) {
            this.__chart__ = view;
