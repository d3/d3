d3 = function() {
  ...
  d3.layout.layer = function() {
    var layer = {}, level = function(d) {
      return d.level;
    }, nodes = [], links = [], vspace = d3_layout_layerVspace, width;
    ...
    layer.relayout = function() {
      var n = nodes.length, m = links.length, i, node, link, nodesOnLevel = {}, nodeLevel;
      for (i = 0; i < n; i++) {
        node = nodes[i];
