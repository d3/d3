...
return a(c,i.actions)};c.remove=function(b){d.push({impl:fa,selector:b});return c};c.text=function(b){d.push({impl:ga,value:b});return c};c.on=function(b){b={impl:ha,type:b,actions:[]};d.push(b);return a(c,b.actions)};c.filter=function(b){b={impl:Q,bind:Q,filter:b,actions:[]};d.push(b);return a(c,b.actions)};c.select=function(b){b={impl:H,bind:ia,selector:b,actions:[]};d.push(b);return a(c,b.actions)};c.selectAll=function(b){b={impl:I,bind:ja,selector:b,actions:[]};d.push(b);return a(c,b.actions)};
