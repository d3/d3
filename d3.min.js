...
parseFloat(b[1])/100,parseFloat(b[2])/100);case "rgb":return{r:L(b[0]),g:L(b[1]),b:L(b[2])}}}if(d=B[a])return d;if(a==null)return B.black;if(a.charAt(0)=="#"){if(a.length==4){c=a.charAt(1);c+=c;e=a.charAt(2);e+=e;f=a.charAt(3);f+=f}else if(a.length==7){c=a.substring(1,3);e=a.substring(3,5);f=a.substring(5,7)}c=parseInt(c,16);e=parseInt(e,16);f=parseInt(f,16)}return{r:c,g:e,b:f}}function S(a,c,e){function f(g){if(g>360)g-=360;else if(g<0)g+=360;if(g<60)return d+(b-d)*g/60;if(g<180)return b;if(g<240)return d+
(b-d)*(240-g)/60;return d}var d,b;a%=360;if(a<0)a+=360;c=c<0?0:c>1?1:c;e=e<0?0:e>1?1:e;b=e<=0.5?e*(1+c):e+c-e*c;d=2*e-b;return{r:Math.round(f(a+120)*255),g:Math.round(f(a)*255),b:Math.round(f(a-120)*255)}}function L(a){var c=parseFloat(a);return a.charAt(a.length-1)=="%"?Math.round(c*2.55):c}function z(a){function c(d){for(var b=[],g,i,h,n,o=0,j=a.length;o<j;o++){h=a[o];b.push(g=[]);g.parentNode=h.parentNode;g.parentData=h.parentData;for(var k=0,p=h.length;k<p;k++)if(n=h[k]){g.push(i=d(n));if(i)i.__data__=
n.__data__}else g.push(null)}return z(b)}function e(d){for(var b=[],g,i,h,n=0,o=a.length;n<o;n++){i=a[n];for(var j=0,k=i.length;j<k;j++)if(h=i[j]){b.push(g=d(h));g.parentNode=h;g.parentData=h.__data__}}return z(b)}function f(d){for(var b=0,g=a.length;b<g;b++)for(var i=a[b],h=0,n=i.length;h<n;h++){var o=i[h];if(o)return d.call(o,o.__data__,h)}return null}a.select=function(d){return c(function(b){return b.querySelector(d)})};a.selectAll=function(d){return e(function(b){b=b.querySelectorAll(d);return Array.prototype.slice.call(b)})};
a.data=function(d,b){function g(p,q){function v(Z){return p.parentNode.appendChild(Z)}var m=0,s=p.length,A=q.length,r=Math.min(s,A),t=Math.max(s,A),w=[],x=[],u=[],y,C;if(b){r={};t=[];var F;for(m=0;m<s;m++){r[F=b.nodeKey(y=p[m])]=y;t.push(F)}for(m=0;m<A;m++){if(y=r[F=b.dataKey(C=q[m])]){y.__data__=C;w[m]=y;x[m]=u[m]=null}else{x[m]={appendChild:v,__data__:C};w[m]=u[m]=null}delete r[F]}for(m=0;m<s;m++)if(t[m]in r)u[m]=p[m]}else{for(;m<r;m++){y=p[m];C=q[m];if(y){y.__data__=C;w[m]=y;x[m]=u[m]=null}else{x[m]=
{appendChild:v,__data__:C};w[m]=u[m]=null}}for(;m<A;m++){x[m]={appendChild:v,__data__:q[m]};w[m]=u[m]=null}for(;m<t;m++){u[m]=p[m];x[m]=w[m]=null}}x.parentNode=w.parentNode=u.parentNode=p.parentNode;x.parentData=w.parentData=u.parentData=p.parentData;o.push(x);j.push(w);k.push(u)}var i=-1,h=a.length,n,o=[],j=[],k=[];if(typeof b=="string")b=$(b);if(typeof d=="function")for(;++i<h;)g(n=a[i],d.call(n,n.parentData,i));else for(;++i<h;)g(n=a[i],d);i=z(j);i.enter=function(p){return z(o).append(p)};i.exit=
function(){return z(k)};return i};a.each=function(d){for(var b=0,g=a.length;b<g;b++)for(var i=a[b],h=0,n=i.length;h<n;h++){var o=i[h];o&&d.call(o,o.__data__,h)}return a};a.attr=function(d,b){function g(){this.removeAttribute(d)}function i(){this.removeAttributeNS(d.space,d.local)}function h(){this.setAttribute(d,b)}function n(){this.setAttributeNS(d.space,d.local,b)}function o(){var k=b.apply(this,arguments);k==null?this.removeAttribute(d):this.setAttribute(d,k)}function j(){var k=b.apply(this,arguments);
k==null?this.removeAttributeNS(d.space,d.local):this.setAttributeNS(d.space,d.local,k)}d=l.ns.qualify(d);if(arguments.length<2)return f(d.local?function(){return this.getAttributeNS(d.space,d.local)}:function(){return this.getAttribute(d)});return a.each(b==null?d.local?i:g:typeof b=="function"?d.local?j:o:d.local?n:h)};a.style=function(d,b,g){function i(){this.style.removeProperty(d)}function h(){this.style.setProperty(d,b,g)}function n(){var o=b.apply(this,arguments);o==null?this.style.removeProperty(d):
this.style.setProperty(d,o,g)}if(arguments.length<3)g=null;if(arguments.length<2)return f(function(){return window.getComputedStyle(this,null).getPropertyValue(d)});return a.each(b==null?i:typeof b=="function"?n:h)};a.text=function(d){function b(){this.appendChild(document.createTextNode(d))}function g(){var i=d.apply(this,arguments);i!=null&&this.appendChild(document.createTextNode(i))}if(arguments.length<1)return f(function(){return this.textContent});a.each(function(){for(;this.lastChild;)this.removeChild(this.lastChild)});
return d==null?a:a.each(typeof d=="function"?g:b)};a.html=function(d){function b(){this.innerHTML=d}function g(){this.innerHTML=d.apply(this,arguments)}if(arguments.length<1)return f(function(){return this.innerHTML});return a.each(typeof d=="function"?g:b)};a.append=function(d){function b(i){return i.appendChild(document.createElement(d))}function g(i){return i.appendChild(document.createElementNS(d.space,d.local))}d=l.ns.qualify(d);return c(d.local?g:b)};a.remove=function(){return c(function(d){var b=
d.parentNode;b.removeChild(d);return b})};a.on=function(d,b){d="on"+d;return a.each(function(g,i){this[d]=function(h){l.event=h;try{b.call(this,g,i)}finally{l.event=null}}})};a.transition=function(d){return M(a,d)};return a}function $(a){return{nodeKey:function(c){return c.getAttribute(a)},dataKey:function(c){return c[a]}}}function M(a,c){function e(j){var k=true,p=-1;a.each(function(){if(g[++p]!=2){var q=(j-i[p])/h[p];if(q>=1)q=1;else{k=false;if(q<0)return;if(!g[p]){g[p]=1;b.start.dispatch.apply(this,
