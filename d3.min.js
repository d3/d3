(function(){function Q(a){return Array.prototype.slice.call(a)}function x(a){return typeof a=="function"?a:function(){return a}}function D(a,b){return function(){var c=b.apply(a,arguments);return arguments.length?a:c}}function ra(a){return a==null}function ca(a){return a.replace(/(^\s+)|(\s+$)/g,"").replace(/\s+/g," ")}function da(a,b){b=Q(arguments);b[0]=this;a.apply(this,b);return this}function sa(){var a={},b=[];a.add=function(c){for(var g=0;g<b.length;g++)if(b[g].listener==c)return a;b.push({listener:c,
...
f.parentNode;i.parentData=f.parentData;for(var o=0,p=f.length;o<p;o++)if((h=f[o])&&e.call(h,h.__data__,o))i.push(h)}return y(d)};a.data=function(e,d){function i(l,n){function q(Ba){return{__data__:Ba,appendChild:function(H){return l.parentNode.appendChild(H)},insertBefore:function(H,Ca){return l.parentNode.insertBefore(H,Ca)},querySelector:function(H){return l.parentNode.querySelector(H)}}}var m=0,r=l.length,t=n.length,s=Math.min(r,t),u=Math.max(r,t),z=[],A=[],v=[],w,B;if(d){s={};u=[];var E;B=n.length;
...
c=x(d);return a};a.startAngle=function(d){if(!arguments.length)return g;g=x(d);return a};a.endAngle=function(d){if(!arguments.length)return e;e=x(d);return a};return a};var O=-Math.PI/2,Za=2*Math.PI-1.0E-6;d3.svg.line=function(){function a(i){return i.length<1?null:"M"+e(Z(this,i,b,c),d)}var b=ka,c=la,g="linear",e=P[g],d=0.7;a.x=function(i){if(!arguments.length)return b;b=i;return a};a.y=function(i){if(!arguments.length)return c;c=i;return a};a.interpolate=function(i){if(!arguments.length)return g;
