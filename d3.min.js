if(!Date.now)Date.now=function(){return+new Date};if(!Object.create)Object.create=function(I){function C(){}C.prototype=I;return new C};
(function(I){function C(a){return Array.prototype.slice.call(a)}function Q(a,c){c=C(arguments);c[0]=this;a.apply(this,c);return this}function V(){var a={},c=[];a.add=function(e){for(var f=0;f<c.length;f++)if(c[f].listener==e)return a;c.push({listener:e,on:true});return a};a.remove=function(e){for(var f=0;f<c.length;f++){var d=c[f];if(d.listener==e){d.on=false;c=c.slice(0,f).concat(c.slice(f+1));break}}return a};a.dispatch=function(){for(var e=c,f=0,d=e.length;f<d;f++){var b=e[f];b.on&&b.listener.apply(this,
...
a+0.984375}function K(a){var c,e,f,d,b;if(d=/([a-z]+)\((.*)\)/i.exec(a)){b=d[2].split(",");switch(d[1]){case "hsl":return T(parseFloat(b[0]),parseFloat(b[1])/100,parseFloat(b[2])/100);case "rgb":return{r:L(b[0]),g:L(b[1]),b:L(b[2])}}}if(d=D[a])return d;if(a==null)return D.black;if(a.charAt(0)=="#"){if(a.length==4){c=a.charAt(1);c+=c;e=a.charAt(2);e+=e;f=a.charAt(3);f+=f}else if(a.length==7){c=a.substring(1,3);e=a.substring(3,5);f=a.substring(5,7)}c=parseInt(c,16);e=parseInt(e,16);f=parseInt(f,16)}return{r:c,
g:e,b:f}}function T(a,c,e){function f(h){if(h>360)h-=360;else if(h<0)h+=360;if(h<60)return d+(b-d)*h/60;if(h<180)return b;if(h<240)return d+(b-d)*(240-h)/60;return d}var d,b;a%=360;if(a<0)a+=360;c=c<0?0:c>1?1:c;e=e<0?0:e>1?1:e;b=e<=0.5?e*(1+c):e+c-e*c;d=2*e-b;return{r:Math.round(f(a+120)*255),g:Math.round(f(a)*255),b:Math.round(f(a-120)*255)}}function L(a){var c=parseFloat(a);return a.charAt(a.length-1)=="%"?Math.round(c*2.55):c}function z(a){function c(d){for(var b=[],h,i,g,n,o=0,j=a.length;o<j;o++){g=
a[o];b.push(h=[]);h.parentNode=g.parentNode;h.parentData=g.parentData;for(var l=0,p=g.length;l<p;l++)if(n=g[l]){h.push(i=d(n));if(i)i.__data__=n.__data__}else h.push(null)}return z(b)}function e(d){for(var b=[],h,i,g,n=0,o=a.length;n<o;n++){i=a[n];for(var j=0,l=i.length;j<l;j++)if(g=i[j]){b.push(h=d(g));h.parentNode=g;h.parentData=g.__data__}}return z(b)}function f(d){for(var b=0,h=a.length;b<h;b++)for(var i=a[b],g=0,n=i.length;g<n;g++){var o=i[g];if(o)return d.call(o,o.__data__,g)}return null}a.select=
function(d){return c(function(b){return b.querySelector(d)})};a.selectAll=function(d){return e(function(b){return C(b.querySelectorAll(d))})};a.data=function(d,b){function h(p,q){function v(aa){return p.parentNode.appendChild(aa)}var m=0,s=p.length,B=q.length,r=Math.min(s,B),t=Math.max(s,B),w=[],x=[],u=[],y,A;if(b){r={};t=[];var E;A=q.length;for(m=0;m<s;m++){E=b.nodeKey(y=p[m]);if(E in r)u[A++]=p[m];else{r[E]=y;t.push(E)}}for(m=0;m<B;m++){if(y=r[E=b.dataKey(A=q[m])]){y.__data__=A;w[m]=y;x[m]=u[m]=
null}else{x[m]={appendChild:v,__data__:A};w[m]=u[m]=null}delete r[E]}for(m=0;m<s;m++)if(t[m]in r)u[m]=p[m]}else{for(;m<r;m++){y=p[m];A=q[m];if(y){y.__data__=A;w[m]=y;x[m]=u[m]=null}else{x[m]={appendChild:v,__data__:A};w[m]=u[m]=null}}for(;m<B;m++){x[m]={appendChild:v,__data__:q[m]};w[m]=u[m]=null}for(;m<t;m++){u[m]=p[m];x[m]=w[m]=null}}x.parentNode=w.parentNode=u.parentNode=p.parentNode;x.parentData=w.parentData=u.parentData=p.parentData;o.push(x);j.push(w);l.push(u)}var i=-1,g=a.length,n,o=[],j=
[],l=[];if(typeof b=="string")b=ba(b);if(typeof d=="function")for(;++i<g;)h(n=a[i],d.call(n,n.parentData,i));else for(;++i<g;)h(n=a[i],d);i=z(j);i.enter=function(p){return z(o).append(p)};i.exit=function(){return z(l)};return i};a.each=function(d){for(var b=0,h=a.length;b<h;b++)for(var i=a[b],g=0,n=i.length;g<n;g++){var o=i[g];o&&d.call(o,o.__data__,g)}return a};a.attr=function(d,b){function h(){this.removeAttribute(d)}function i(){this.removeAttributeNS(d.space,d.local)}function g(){this.setAttribute(d,
b)}function n(){this.setAttributeNS(d.space,d.local,b)}function o(){var l=b.apply(this,arguments);l==null?this.removeAttribute(d):this.setAttribute(d,l)}function j(){var l=b.apply(this,arguments);l==null?this.removeAttributeNS(d.space,d.local):this.setAttributeNS(d.space,d.local,l)}d=k.ns.qualify(d);if(arguments.length<2)return f(d.local?function(){return this.getAttributeNS(d.space,d.local)}:function(){return this.getAttribute(d)});return a.each(b==null?d.local?i:h:typeof b=="function"?d.local?j:
o:d.local?n:g)};a.style=function(d,b,h){function i(){this.style.removeProperty(d)}function g(){this.style.setProperty(d,b,h)}function n(){var o=b.apply(this,arguments);o==null?this.style.removeProperty(d):this.style.setProperty(d,o,h)}if(arguments.length<3)h=null;if(arguments.length<2)return f(function(){return window.getComputedStyle(this,null).getPropertyValue(d)});return a.each(b==null?i:typeof b=="function"?n:g)};a.property=function(d,b){function h(){delete this[d]}function i(){this[d]=b}function g(){var n=
b.apply(this,arguments);if(n==null)delete this[d];else this[d]=n}d=k.ns.qualify(d);if(arguments.length<2)return f(function(){return this[d]});return a.each(b==null?h:typeof b=="function"?g:i)};a.text=function(d){function b(){this.appendChild(document.createTextNode(d))}function h(){var i=d.apply(this,arguments);i!=null&&this.appendChild(document.createTextNode(i))}if(arguments.length<1)return f(function(){return this.textContent});a.each(function(){for(;this.lastChild;)this.removeChild(this.lastChild)});
...
d.parentNode;b.removeChild(d);return b})};a.on=function(d,b){d="on"+d;return a.each(function(h,i){this[d]=function(g){k.event=g;try{b.call(this,h,i)}finally{k.event=null}}})};a.transition=function(d){return M(a,d)};a.call=Q;return a}function ba(a){return{nodeKey:function(c){return c.getAttribute(a)},dataKey:function(c){return c[a]}}}function M(a,c){function e(j){var l=true,p=-1;a.each(function(){if(h[++p]!=2){var q=(j-i[p])/g[p];if(q>=1)q=1;else{l=false;if(q<0)return;if(!h[p]){h[p]=1;b.start.dispatch.apply(this,
...
a.range=function(b){if(!arguments.length)return f;f=b;return a};a.rangePoints=function(b,h){if(arguments.length<2)h=0;var i=b[0],g=b[1],n=(g-i)/(c.length-1+h);f=c.length==1?[(i+g)/2]:k.range(i+n*h/2,g+n/2,n);d=0;return a};a.rangeBands=function(b,h){if(arguments.length<2)h=0;var i=b[0],g=b[1],n=(g-i)/(c.length+h);f=k.range(i+n*h,g,n);d=n*(1-h);return a};a.rangeBand=function(){return d};return a};k.category10=function(){return k.ordinal().range(la)};k.category19=function(){return k.ordinal().range(ma)};
k.category20=function(){return k.ordinal().range(na)};var la=["#1f77b4","#ff7f0e","#2ca02c","#d62728","#9467bd","#8c564b","#e377c2","#7f7f7f","#bcbd22","#17becf"],ma=["#9c9ede","#7375b5","#4a5584","#cedb9c","#b5cf6b","#8ca252","#637939","#e7cb94","#e7ba52","#bd9e39","#8c6d31","#e7969c","#d6616b","#ad494a","#843c39","#de9ed6","#ce6dbd","#a55194","#7b4173"],na=["#1f77b4","#aec7e8","#ff7f0e","#ffbb78","#2ca02c","#98df8a","#d62728","#ff9896","#9467bd","#c5b0d5","#8c564b","#c49c94","#e377c2","#f7b6d2",
"#7f7f7f","#c7c7c7","#bcbd22","#dbdb8d","#17becf","#9edae5"],H=z([[document]]);H[0].parentNode=document.documentElement;k.select=function(a){return typeof a=="string"?H.select(a):z([[a]])};k.selectAll=function(a){return typeof a=="string"?H.selectAll(a):z([C(a)])};k.transition=H.transition;var F=null,N=0,G;k.arc=function(){function a(b){var h=c(b),i=e(b),g=f(b)-Math.PI/2,n=d(b)-Math.PI/2;b=n-g;var o=Math.cos(g);g=Math.sin(g);var j=Math.cos(n);n=Math.sin(n);return"M"+i*o+","+i*g+"A"+i+","+i+" 0 "+
(b<Math.PI?"0":"1")+",1 "+i*j+","+i*n+"L"+h*j+","+h*n+"A"+h+","+h+" 0 "+(b<Math.PI?"0":"1")+",0 "+h*o+","+h*g+"Z"}var c=function(b){return b.innerRadius},e=function(b){return b.outerRadius},f=function(b){return b.startAngle},d=function(b){return b.endAngle};a.innerRadius=function(b){c=typeof b=="function"?b:function(){return b};return a};a.outerRadius=function(b){e=typeof b=="function"?b:function(){return b};return a};a.startAngle=function(b){f=typeof b=="function"?b:function(){return b};return a};
a.endAngle=function(b){d=typeof b=="function"?b:function(){return b};return a};return a};k.line=function(){function a(f){var d=[],b=0,h=f[0];for(d.push("M",c.call(this,h,b),",",e.call(this,h,b));h=f[++b];)d.push("L",c.call(this,h,b),",",e.call(this,h,b));return d.join("")}var c=function(f){return f.x},e=function(f){return f.y};a.x=function(f){c=f;return a};a.y=function(f){e=f;return a};return a};k.area=function(){function a(d){var b=[],h=0,i=d[0];for(b.push("M",c.call(this,i,h),","+e+"V",f.call(this,
i,h));i=d[++h];)b.push("L",c.call(this,i,h),",",f.call(this,i,h));b.push("V"+e+"Z");return b.join("")}var c=function(d){return d.x},e=0,f=function(d){return d.y1};a.x=function(d){c=d;return a};a.y0=function(d){e=d;return a};a.y1=function(d){f=d;return a};return a}})(this);
