...
c).ease(o);l=-1;j.delay(function(p,q){return i[q?l:++l]});l=-1;j.duration(function(p,q){return g[q?l:++l]});return j};f.each=function(j,l){b[j].add(l);return f};f.call=Q;return f.delay(0).duration(250)}function ca(a,c){for(var e=Date.now(),f=false,d=e+c,b=F;b;){if(b.callback==a){b.then=e;b.delay=c;f=true}else{var h=b.then+b.delay;if(h<d)d=h}b=b.next}f||(F={callback:a,then:e,delay:c,next:F});if(!G){clearTimeout(N);N=setTimeout(da,Math.min(24,d-e))}}function da(){G=setInterval(ea,24);N=0}function ea(){for(var a,
c=Date.now(),e=F;e;){a=c-e.then;if(a>e.delay)e.flush=e.callback(a);e=e.next}a=null;for(c=F;c;)c=c.flush?a?a.next=c.next:F=c.next:(a=c).next;a||(G=clearInterval(G))}function U(a){return typeof a=="function"?function(c,e,f){return k.interpolate(f,a.call(this,c,e))}:function(c,e,f){return k.interpolate(f,a)}}var k=I.d3={};k.version="0.1.2";k.range=function(a,c,e){if(arguments.length==1){c=a;a=0}if(e==null)e=1;if((c-a)/e==Infinity)throw Error("infinite range");var f=[],d=-1,b;if(e<0)for(;(b=a+e*++d)>
c;)f.push(b);else for(;(b=a+e*++d)<c;)f.push(b);return f};k.ns={prefix:{svg:"http://www.w3.org/2000/svg",xhtml:"http://www.w3.org/1999/xhtml",xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"},qualify:function(a){var c=a.indexOf(":");return c<0?a:{space:k.ns.prefix[a.substring(0,c)],local:a.substring(c+1)}}};k.dispatch=function(){for(var a={},c,e=0,f=arguments.length;e<f;e++){c=arguments[e];a[c]=V(c)}return a};k.format=function(a){a=
fa.exec(a);var c=a[1]||" ",e=a[5],f=+a[6],d=a[7],b=a[8],h=a[9];if(b)b=b.substring(1);if(e)c="0";if(h=="d")b="0";return function(i){if(h=="d"&&i%1)return"";if(b)i=(+i).toFixed(b);else i+="";if(d){for(var g=i.lastIndexOf("."),n=g>=0?i.substring(g):(g=i.length,""),o=[];g>0;)o.push(i.substring(g-=3,g+3));i=o.reverse().join(",")+n}g=i.length;if(g<f)i=Array(f-g+1).join(c)+i;return i}};var fa=/(?:([^{])?([<>=^]))?([+\- ])?(#)?(0)?([0-9]+)?(,)?(\.[0-9]+)?([a-zA-Z%])?/,ga=J(2),ha=J(3),ia={linear:function(){return W},
...
k.ease=function(a){var c=a.indexOf("-"),e=c>=0?a.substring(0,c):a;c=c>=0?a.substring(c+1):"in";return ja[c](ia[e].apply(null,Array.prototype.slice.call(arguments,1)))};k.event=null;k.interpolate=function(a,c){if(typeof c=="number")return k.interpolateNumber(+a,c);if(typeof c=="string")return c in D||/^(#|rgb\(|hsl\()/.test(c)?k.interpolateRgb(String(a),c):k.interpolateString(String(a),c);if(c instanceof Array)return k.interpolateArray(a,c);return k.interpolateObject(a,c)};k.interpolateNumber=function(a,
...
yellow:"#ffff00",yellowgreen:"#9acd32"},P;for(P in D)D[P]=K(D[P]);k.hsl=function(a,c,e){a=T(a,c,e);return"rgb("+a.r+","+a.g+","+a.b+")"};k.linear=function(){function a(g){return i((g-e)*h)}function c(g){var n=Math.min(e,f),o=Math.max(e,f),j=o-n,l=Math.pow(10,Math.floor(Math.log(j/g)/Math.LN10));g=g/(j/l);if(g<=0.15)l*=10;else if(g<=0.35)l*=5;else if(g<=0.75)l*=2;return{start:Math.ceil(n/l)*l,stop:Math.floor(o/l)*l+l*0.5,step:l}}var e=0,f=1,d=0,b=1,h=1/(f-e),i=k.interpolate(d,b);a.invert=function(g){return(g-
d)/h+e};a.domain=function(g){if(!arguments.length)return[e,f];e=g[0];f=g[1];h=1/(f-e);return a};a.range=function(g){if(!arguments.length)return[d,b];d=g[0];b=g[1];i=k.interpolate(d,b);return a};a.ticks=function(g){g=c(g);return k.range(g.start,g.stop,g.step)};a.tickFormat=function(g){g=Math.max(0,-Math.floor(Math.log(c(g).step)/Math.LN10+0.01));return k.format(",."+g+"f")};return a};k.log=function(){function a(e){return c(Math.log(e))}var c=k.linear();a.invert=function(e){return Math.exp(c.invert(e))};
a.domain=function(e){if(!arguments.length)return c.domain().map(Math.exp);c.domain(e.map(Math.log));return a};a.range=function(){var e=c.range.apply(c,arguments);return arguments.length?a:e};return a};k.pow=function(){function a(h){return Math.pow(h,d)}function c(h){return Math.pow(h,b)}function e(h){return f(a(h))}var f=k.linear(),d=1,b=1/d;e.invert=function(h){return c(f.invert(h))};e.domain=function(h){if(!arguments.length)return f.domain().map(c);f.domain(h.map(a));return e};e.range=function(){var h=
...
var la=["#1f77b4","#ff7f0e","#2ca02c","#d62728","#9467bd","#8c564b","#e377c2","#7f7f7f","#bcbd22","#17becf"],ma=["#9c9ede","#7375b5","#4a5584","#cedb9c","#b5cf6b","#8ca252","#637939","#e7cb94","#e7ba52","#bd9e39","#8c6d31","#e7969c","#d6616b","#ad494a","#843c39","#de9ed6","#ce6dbd","#a55194","#7b4173"],na=["#1f77b4","#aec7e8","#ff7f0e","#ffbb78","#2ca02c","#98df8a","#d62728","#ff9896","#9467bd","#c5b0d5","#8c564b","#c49c94","#e377c2","#f7b6d2","#7f7f7f","#c7c7c7","#bcbd22","#dbdb8d","#17becf","#9edae5"],
H=z([[document]]);H[0].parentNode=document.documentElement;k.select=function(a){return typeof a=="string"?H.select(a):z([[a]])};k.selectAll=function(a){return typeof a=="string"?H.selectAll(a):z([C(a)])};k.transition=H.transition;var F=null,N=0,G;k.arc=function(){function a(b){var h=c(b),i=e(b),g=f(b)-Math.PI/2,n=d(b)-Math.PI/2;b=n-g;var o=Math.cos(g);g=Math.sin(g);var j=Math.cos(n);n=Math.sin(n);return"M"+i*o+","+i*g+"A"+i+","+i+" 0 "+(b<Math.PI?"0":"1")+",1 "+i*j+","+i*n+"L"+h*j+","+h*n+"A"+h+","+
h+" 0 "+(b<Math.PI?"0":"1")+",0 "+h*o+","+h*g+"Z"}var c=function(b){return b.innerRadius},e=function(b){return b.outerRadius},f=function(b){return b.startAngle},d=function(b){return b.endAngle};a.innerRadius=function(b){c=typeof b=="function"?b:function(){return b};return a};a.outerRadius=function(b){e=typeof b=="function"?b:function(){return b};return a};a.startAngle=function(b){f=typeof b=="function"?b:function(){return b};return a};a.endAngle=function(b){d=typeof b=="function"?b:function(){return b};
return a};return a};k.line=function(){function a(f){var d=[],b=0,h=f[0];for(d.push("M",c.call(this,h,b),",",e.call(this,h,b));h=f[++b];)d.push("L",c.call(this,h,b),",",e.call(this,h,b));return d.join("")}var c=function(f){return f.x},e=function(f){return f.y};a.x=function(f){c=f;return a};a.y=function(f){e=f;return a};return a};k.area=function(){function a(d){var b=[],h=0,i=d[0];for(b.push("M",c.call(this,i,h),","+e+"V",f.call(this,i,h));i=d[++h];)b.push("L",c.call(this,i,h),",",f.call(this,i,h));
b.push("V"+e+"Z");return b.join("")}var c=function(d){return d.x},e=0,f=function(d){return d.y1};a.x=function(d){c=d;return a};a.y0=function(d){e=d;return a};a.y1=function(d){f=d;return a};return a}})(this);
