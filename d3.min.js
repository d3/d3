(function(){var o=null;d3={version:"0.24.0"};if(!Date.now)Date.now=function(){return+new Date};if(!Object.create)Object.create=function(a){function b(){}b.prototype=a;return new b};function w(a){return Array.prototype.slice.call(a)}function x(a){return typeof a=="function"?a:function(){return a}}d3.merge=function(a){return Array.prototype.concat.apply([],a)};
...
d3.interpolateString=function(a,b){var e,f,c=0,d=[],g=[],h,i;for(f=0;e=H.exec(b);++f){e.index&&d.push(b.substring(c,e.index));g.push({a:d.length,x:e[0]});d.push(o);c=H.lastIndex}c<b.length&&d.push(b.substring(c));f=0;for(h=g.length;(e=H.exec(a))&&f<h;++f){i=g[f];if(i.x==e[0]){if(i.a)if(d[i.a+1]==o){d[i.a-1]+=i.x;d.splice(i.a,1);for(e=f+1;e<h;++e)g[e].a--}else{d[i.a-1]+=i.x+d[i.a+1];d.splice(i.a,2);for(e=f+1;e<h;++e)g[e].a-=2}else if(d[i.a+1]==o)d[i.a]=i.x;else{d[i.a]=i.x+d[i.a+1];d.splice(i.a+1,1);
for(e=f+1;e<h;++e)g[e].a--}g.splice(f,1);h--;f--}else i.x=d3.interpolateNumber(parseFloat(e[0]),parseFloat(i.x))}for(;f<h;){i=g.pop();if(d[i.a+1]==o)d[i.a]=i.x;else{d[i.a]=i.x+d[i.a+1];d.splice(i.a+1,1)}h--}if(d.length==1)return d[0]==o?g[0].x:function(){return b};return function(j){for(f=0;f<h;++f)d[(i=g[f]).a]=i.x(j);return d.join("")}};
...
function I(a,b,e){var f,c,d,g,h;if(g=/([a-z]+)\((.*)\)/i.exec(a)){h=g[2].split(",");switch(g[1]){case "hsl":return e(parseFloat(h[0]),parseFloat(h[1])/100,parseFloat(h[2])/100);case "rgb":return b(L(h[0]),L(h[1]),L(h[2]))}}if(e=G[a])return b(e.r,e.g,e.b);if(a==o)return b(0,0,0);if(a.charAt(0)=="#"){if(a.length==4){f=a.charAt(1);f+=f;c=a.charAt(2);c+=c;d=a.charAt(3);d+=d}else if(a.length==7){f=a.substring(1,3);c=a.substring(3,5);d=a.substring(5,7)}f=parseInt(f,16);c=parseInt(c,16);d=parseInt(d,16)}return b(f,
...
function O(a){function b(c){for(var d=[],g,h,i,j,m=0,p=a.length;m<p;m++){i=a[m];d.push(g=[]);g.parentNode=i.parentNode;g.parentData=i.parentData;for(var q=0,k=i.length;q<k;q++)if(j=i[q]){g.push(h=c(j));if(h&&"__data__"in j)h.__data__=j.__data__}else g.push(o)}return O(d)}function e(c){for(var d=[],g,h,i,j=0,m=a.length;j<m;j++){h=a[j];for(var p=0,q=h.length;p<q;p++)if(i=h[p]){d.push(g=c(i));g.parentNode=i;g.parentData=i.__data__}}return O(d)}function f(c){for(var d=0,g=a.length;d<g;d++)for(var h=a[d],
i=0,j=h.length;i<j;i++){var m=h[i];if(m)return c.call(m,m.__data__,i)}return o}a.select=function(c){return b(function(d){return d.querySelector(c)})};a.selectAll=function(c){return e(function(d){return w(d.querySelectorAll(c))})};a.filter=function(c){for(var d=[],g,h,i,j=0,m=a.length;j<m;j++){h=a[j];d.push(g=[]);g.parentNode=h.parentNode;g.parentData=h.parentData;for(var p=0,q=h.length;p<q;p++)if((i=h[p])&&c.call(i,i.__data__,p))g.push(i)}return O(d)};a.data=function(c,d){function g(k,n){function r(Ea){return k.parentNode.appendChild(Ea)}
var l=0,s=k.length,t=n.length,u=Math.min(s,t),B=Math.max(s,t),y=[],z=[],v=[],A,C;if(d){u={};B=[];var D;C=n.length;for(l=0;l<s;l++){D=d.nodeKey(A=k[l]);if(D in u)v[C++]=k[l];else{u[D]=A;B.push(D)}}for(l=0;l<t;l++){if(A=u[D=d.dataKey(C=n[l])]){A.__data__=C;y[l]=A;z[l]=v[l]=o}else{z[l]={appendChild:r,__data__:C};y[l]=v[l]=o}delete u[D]}for(l=0;l<s;l++)if(B[l]in u)v[l]=k[l]}else{for(;l<u;l++){A=k[l];C=n[l];if(A){A.__data__=C;y[l]=A;z[l]=v[l]=o}else{z[l]={appendChild:r,__data__:C};y[l]=v[l]=o}}for(;l<
t;l++){z[l]={appendChild:r,__data__:n[l]};y[l]=v[l]=o}for(;l<B;l++){v[l]=k[l];z[l]=y[l]=o}}z.parentNode=y.parentNode=v.parentNode=k.parentNode;z.parentData=y.parentData=v.parentData=k.parentData;m.push(z);p.push(y);q.push(v)}var h=-1,i=a.length,j,m=[],p=[],q=[];if(typeof d=="string")d=va(d);if(typeof c=="function")for(;++h<i;)g(j=a[h],c.call(j,j.parentData,h));else for(;++h<i;)g(j=a[h],c);h=O(p);h.enter=function(k){return O(m).append(k)};h.exit=function(){return O(q)};return h};a.each=function(c){for(var d=
0,g=a.length;d<g;d++)for(var h=a[d],i=0,j=h.length;i<j;i++){var m=h[i];m&&c.call(m,m.__data__,i)}return a};a.node=function(){return f(function(){return this})};a.attr=function(c,d){function g(){this.removeAttribute(c)}function h(){this.removeAttributeNS(c.space,c.local)}function i(){this.setAttribute(c,d)}function j(){this.setAttributeNS(c.space,c.local,d)}function m(){var q=d.apply(this,arguments);q==o?this.removeAttribute(c):this.setAttribute(c,q)}function p(){var q=d.apply(this,arguments);q==o?
this.removeAttributeNS(c.space,c.local):this.setAttributeNS(c.space,c.local,q)}c=d3.ns.qualify(c);if(arguments.length<2)return f(c.local?function(){return this.getAttributeNS(c.space,c.local)}:function(){return this.getAttribute(c)});return a.each(d==o?c.local?h:g:typeof d=="function"?c.local?p:m:c.local?j:i)};a.style=function(c,d,g){function h(){this.style.removeProperty(c)}function i(){this.style.setProperty(c,d,g)}function j(){var m=d.apply(this,arguments);m==o?this.style.removeProperty(c):this.style.setProperty(c,
m,g)}if(arguments.length<3)g=o;if(arguments.length<2)return f(function(){return window.getComputedStyle(this,o).getPropertyValue(c)});return a.each(d==o?h:typeof d=="function"?j:i)};a.property=function(c,d){function g(){delete this[c]}function h(){this[c]=d}function i(){var j=d.apply(this,arguments);if(j==o)delete this[c];else this[c]=j}c=d3.ns.qualify(c);if(arguments.length<2)return f(function(){return this[c]});return a.each(d==o?g:typeof d=="function"?i:h)};a.text=function(c){function d(){this.appendChild(document.createTextNode(c))}
function g(){var h=c.apply(this,arguments);h!=o&&this.appendChild(document.createTextNode(h))}if(arguments.length<1)return f(function(){return this.textContent});a.each(function(){for(;this.lastChild;)this.removeChild(this.lastChild)});return c==o?a:a.each(typeof c=="function"?g:d)};a.html=function(c){function d(){this.innerHTML=c}function g(){this.innerHTML=c.apply(this,arguments)}if(arguments.length<1)return f(function(){return this.innerHTML});return a.each(typeof c=="function"?g:d)};a.append=
function(c){function d(h){return h.appendChild(document.createElement(c))}function g(h){return h.appendChild(document.createElementNS(c.space,c.local))}c=d3.ns.qualify(c);return b(c.local?g:d)};a.remove=function(){return b(function(c){var d=c.parentNode;d.removeChild(c);return d})};a.sort=function(c){c=wa.apply(this,arguments);for(var d=0,g=a.length;d<g;d++){var h=a[d];h.sort(c);for(var i=1,j=h.length,m=h[0];i<j;i++){var p=h[i];if(p){m&&m.parentNode.insertBefore(p,m.nextSibling);m=p}}}return a};a.on=
...
function Q(a){function b(k){var n=true,r=-1;a.each(function(){if(i[++r]!=2){var l=(k-j[r])/m[r],s=this.__transition__,t,u=d[r];if(l<1){n=false;if(!(l<0)){if(i[r]){if(s.c!=f){i[r]=2;return}}else if(!s||s.c>f){i[r]=2;return}else{i[r]=1;h.start.dispatch.apply(this,arguments);u=d[r]={};s.c=f;for(t in c)u[t]=c[t].apply(this,arguments)}s=q(l);for(t in c)u[t].call(this,s)}}else{i[r]=2;if(s.c==f){l=s.k;for(t in c)u[t].call(this,1);if(l==f){delete this.__transition__;g&&this.parentNode.removeChild(this)}R=
f;h.end.dispatch.apply(this,arguments);R=0;s.k=l}}}});return n}var e={},f=R||++ya,c={},d=[],g=false,h=d3.dispatch("start","end"),i=[],j=[],m=[],p,q=d3.ease("cubic-in-out");a.each(function(){(this.__transition__||(this.__transition__={})).k=f});e.delay=function(k){var n=Infinity,r=-1;if(typeof k=="function")a.each(function(){var l=j[++r]=+k.apply(this,arguments);if(l<n)n=l});else{n=+k;a.each(function(){j[++r]=n})}za(b,n);return e};e.duration=function(k){var n=-1;if(typeof k=="function"){p=0;a.each(function(){var r=
m[++n]=+k.apply(this,arguments);if(r>p)p=r})}else{p=+k;a.each(function(){m[++n]=p})}return e};e.ease=function(k){q=typeof k=="string"?d3.ease(k):k;return e};e.attrTween=function(k,n){function r(s,t){var u=n.call(this,s,t,this.getAttribute(k));return function(B){this.setAttribute(k,u(B))}}function l(s,t){var u=n.call(this,s,t,this.getAttributeNS(k.space,k.local));return function(B){this.setAttributeNS(k.space,k.local,u(B))}}c["attr."+k]=k.local?l:r;return e};e.attr=function(k,n){return e.attrTween(k,
Aa(n))};e.styleTween=function(k,n,r){c["style."+k]=function(l,s){var t=n.call(this,l,s,window.getComputedStyle(this,o).getPropertyValue(k));return function(u){this.style.setProperty(k,t(u),r)}};return e};e.style=function(k,n,r){return e.styleTween(k,Aa(n),r)};e.select=function(k){var n;k=Q(a.select(k)).ease(q);n=-1;k.delay(function(){return j[++n]});n=-1;k.duration(function(){return m[++n]});return k};e.selectAll=function(k){var n;k=Q(a.selectAll(k)).ease(q);n=-1;k.delay(function(r,l){return j[l?
n:++n]});n=-1;k.duration(function(r,l){return m[l?n:++n]});return k};e.remove=function(){g=true;return e};e.each=function(k,n){h[k].add(n);return e};e.call=E;return e.delay(0).duration(250)}var S=o,T=0,U;function za(a,b){var e=Date.now(),f=false,c=e+b,d=S;if(isFinite(b)){for(;d;){if(d.j==a){d.i=e;d.delay=b;f=true}else{var g=d.i+d.delay;if(g<c)c=g}d=d.next}f||(S={j:a,i:e,delay:b,next:S});if(!U){clearTimeout(T);T=setTimeout(Ba,Math.max(24,c-e))}}}function Ba(){U=setInterval(Ca,24);T=0}
function Ca(){for(var a,b=Date.now(),e=S;e;){a=b-e.i;if(a>e.delay)e.n=e.j(a);e=e.next}a=o;for(b=S;b;)b=b.n?a?a.next=b.next:S=b.next:(a=b).next;a||(U=clearInterval(U))}function Aa(a){return typeof a=="function"?function(b,e,f){return d3.interpolate(f,a.call(this,b,e))}:function(b,e,f){return d3.interpolate(f,a)}}d3.scale={};
d3.scale.linear=function(){function a(j){return i((j-e)*g)}function b(j){var m=Math.min(e,f),p=Math.max(e,f),q=p-m,k=Math.pow(10,Math.floor(Math.log(q/j)/Math.LN10));j=j/(q/k);if(j<=0.15)k*=10;else if(j<=0.35)k*=5;else if(j<=0.75)k*=2;return{start:Math.ceil(m/k)*k,stop:Math.floor(p/k)*k+k*0.5,m:k}}var e=0,f=1,c=0,d=1,g=1/(f-e),h=(f-e)/(d-c),i=d3.interpolate(c,d);a.invert=function(j){return(j-c)*h+e};a.domain=function(j){if(!arguments.length)return[e,f];e=j[0];f=j[1];g=1/(f-e);h=(f-e)/(d-c);return a};
...
d3.svg.arc=function(){function a(d,g){var h=b.call(this,d,g),i=e.call(this,d,g),j=f.call(this,d,g)+V,m=c.call(this,d,g)+V,p=m-j,q=Math.cos(j);j=Math.sin(j);var k=Math.cos(m);m=Math.sin(m);return"M"+i*q+","+i*j+"A"+i+","+i+" 0 "+(p<Math.PI?"0":"1")+",1 "+i*k+","+i*m+"L"+h*k+","+h*m+"A"+h+","+h+" 0 "+(p<Math.PI?"0":"1")+",0 "+h*q+","+h*j+"Z"}var b=Ia,e=Ja,f=Ka,c=La;a.innerRadius=function(d){if(!arguments.length)return b;b=x(d);return a};a.outerRadius=function(d){if(!arguments.length)return e;e=x(d);
...
d3.svg.area=function(){function a(g){return g.length<1?o:"M"+d(W(this,g,b,f))+"L"+d(W(this,g,b,e).reverse())+"Z"}var b=Ma,e=Ta,f=Na,c="linear",d=X[c];a.x=function(g){if(!arguments.length)return b;b=g;return a};a.y0=function(g){if(!arguments.length)return e;e=g;return a};a.y1=function(g){if(!arguments.length)return f;f=g;return a};a.interpolate=function(g){if(!arguments.length)return c;d=X[c=g];return a};return a};function Ta(){return 0}
d3.svg.chord=function(){function a(g,h){var i=b.call(this,g,h),j=e.call(this,g,h),m=f.call(this,i,h),p=c.call(this,i,h)+V;i=d.call(this,i,h)+V;var q=f.call(this,j,h),k=c.call(this,j,h)+V;j=d.call(this,j,h)+V;var n=m*Math.cos(p);p=m*Math.sin(p);return"M"+n+","+p+"A"+m+","+m+" 0  0,1 "+m*Math.cos(i)+","+m*Math.sin(i)+"Q 0,0 "+q*Math.cos(k)+","+q*Math.sin(k)+"A"+q+","+q+" 0  0,1 "+q*Math.cos(j)+","+q*Math.sin(j)+"Q 0,0 "+n+","+p+"Z"}var b=Ua,e=Va,f=Wa,c=Ka,d=La;a.radius=function(g){if(!arguments.length)return f;
f=x(g);return a};a.source=function(g){if(!arguments.length)return b;b=x(g);return a};a.target=function(g){if(!arguments.length)return e;e=x(g);return a};a.startAngle=function(g){if(!arguments.length)return c;c=x(g);return a};a.endAngle=function(g){if(!arguments.length)return d;d=x(g);return a};return a};function Ua(a){return a.source}function Va(a){return a.target}function Wa(a){return a.radius}
