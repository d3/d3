...
(function(F){function E(){var a={},b=[];a.add=function(e){for(var f=0;f<b.length;f++)if(b[f].listener==e)return a;b.push({listener:e,on:true});return a};a.remove=function(e){for(var f=0;f<b.length;f++){var c=b[f];if(c.listener==e){c.on=false;b=b.slice(0,f).concat(b.slice(f+1));break}}return a};a.dispatch=function(){for(var e=b,f=0,c=e.length;f<c;f++){var d=e[f];d.on&&d.listener.apply(this,arguments)}};return a}function S(){for(var a={},b,e=0,f=arguments.length;e<f;e++){b=arguments[e];a[b]=E(b)}return a}
function N(a){return function(b){return 1-a(1-b)}}function O(a){return function(b){return 0.5*(b<0.5?a(2*b):2-a(2-2*b))}}function T(a){return a}function G(a){return function(b){return Math.pow(b,a)}}function U(a){return 1-Math.cos(a*Math.PI/2)}function V(a){return a?Math.pow(2,10*(a-1))-0.0010:0}function W(a){return 1-Math.sqrt(1-a*a)}function X(a){return a<1/2.75?7.5625*a*a:a<2/2.75?7.5625*(a-=1.5/2.75)*a+0.75:a<2.5/2.75?7.5625*(a-=2.25/2.75)*a+0.9375:7.5625*(a-=2.625/2.75)*a+0.984375}function Y(a){return{nodeKey:function(b){return b.getAttribute(a)},
...
[],h,i,g,m,o=0,r=a.length;o<r;o++){g=a[o];d.push(h=[]);h.parentNodes=g;h.parentData=g.parentData;for(var p=0,s=g.length;p<s;p++)if(m=g[p]){h.push(i=c(m));if(i)i.__data__=m.__data__}else h.push(null)}return A(d)}function e(c){for(var d=[],h,i,g,m=0,o=a.length;m<o;m++){i=a[m];for(var r=0,p=i.length;r<p;r++)if(g=i[r]){d.push(h=c(g));h.parentNode=g;h.parentData=g.__data__}}return A(d)}function f(c){for(var d=0,h=a.length;d<h;d++)for(var i=a[d],g=0,m=i.length;g<m;g++){var o=i[g];if(o)return c.call(o,o.__data__,
g)}return null}a.select=function(c){return b(function(d){return d.querySelector(c)})};a.selectAll=function(c){return e(function(d){d=d.querySelectorAll(c);return Array.prototype.slice.call(d)})};a.data=function(c,d){function h(s,k){function n(Z,$){var aa=s.parentNode||s.parentNodes[$];return{appendChild:function(ba){return aa.appendChild(ba)},__data__:Z}}var j=0,q=s.length,x=k.length,u=Math.min(q,x),w=Math.max(q,x),y=[],v=[],t=[],z,C;if(d){u={};w={};var Q=[],D;for(j=0;j<q;j++){u[D=d.nodeKey(z=s[j])]=
z;w[D]=j;Q.push(D)}for(j=0;j<x;j++){if(z=u[D=d.dataKey(C=k[j])]){z.__data__=C;y[j]=z;v[j]=t[j]=null}else{v[j]=n(C,w[D]);y[j]=t[j]=null}delete u[D]}for(j=0;j<q;j++)if(Q[j]in u)t[j]=s[j]}else{for(;j<u;j++){z=s[j];C=k[j];if(z){z.__data__=C;y[j]=z;v[j]=t[j]=null}else{v[j]=n(C,j);y[j]=t[j]=null}}for(;j<x;j++){v[j]=n(k[j],j);y[j]=t[j]=null}for(;j<w;j++){t[j]=s[j];v[j]=y[j]=null}}o.push(v);r.push(y);p.push(t)}var i=-1,g=a.length,m,o=[],r=[],p=[];if(typeof d=="string")d=Y(d);if(typeof c=="function")for(;++i<
g;)h(m=a[i],c.call(m,m.parentData,i));else for(;++i<g;)h(m=a[i],c);i=A(r);i.enter=function(s){return A(o).append(s)};i.exit=function(){return A(p)};return i};a.each=function(c){for(var d=0,h=a.length;d<h;d++)for(var i=a[d],g=0,m=i.length;g<m;g++){var o=i[g];o&&c.call(o,o.__data__,g)}return a};a.attr=function(c,d){function h(){this.removeAttribute(c)}function i(){this.removeAttributeNS(c.space,c.local)}function g(){this.setAttribute(c,d)}function m(){this.setAttributeNS(c.space,c.local,d)}function o(){var p=
...
if(!m[j]){m[j]=1;g.start.dispatch.apply(this,arguments)}}var x=s(q),u;for(u in c)c[u].call(this,x,j);if(q==1){m[j]=2;g.end.dispatch.apply(this,arguments)}}});n&&clearInterval(h)}var f={},c={},d=setTimeout(b,1),h,i=Date.now(),g=S("start","end"),m=[],o=[],r=[],p,s=l.ease("cubic-in-out");f.delay=function(k){var n=Infinity,j=-1;if(typeof k=="function")a.each(function(){var q=o[++j]=+k.apply(this,arguments);if(q<n)n=q});else{n=+k;a.each(function(){o[++j]=n})}clearTimeout(d);d=setTimeout(b,n);return f};
f.duration=function(k){var n=-1;if(typeof k=="function"){p=0;a.each(function(){var j=r[++n]=+k.apply(this,arguments);if(j>p)p=j})}else{p=+k;a.each(function(){r[++n]=p})}return f};f.ease=function(k){s=l.ease(k);return f};f.attrTween=function(k,n){function j(v,t){w[++y]=n.call(this,v,t,this.getAttribute(k))}function q(v,t){w[++y]=n.call(this,v,t,this.getAttributeNS(k.space,k.local))}function x(v,t){this.setAttribute(k,w[t](v))}function u(v,t){this.setAttributeNS(k.space,k.local,w[t](v))}var w=[],y=
-1;k=l.ns.qualify(k);a.each(k.local?q:j);c["attr."+k]=k.local?u:x;return f};f.attr=function(k,n){return f.attrTween(k,R(n))};f.styleTween=function(k,n,j){var q=[],x=-1;a.each(function(u,w){q[++x]=n.call(this,u,w,window.getComputedStyle(this,null).getPropertyValue(k))});c["style."+k]=function(u,w){this.style.setProperty(k,q[w](u),j)};return f};f.style=function(k,n,j){return f.styleTween(k,R(n),j)};f.select=function(k){var n;k=J(a.select(k)).ease(s);n=-1;k.delay(function(){return o[++n]});n=-1;k.duration(function(){return r[++n]});
return k};f.selectAll=function(k){var n;k=J(a.selectAll(k)).ease(s);n=-1;k.delay(function(j,q){return o[q?n:++n]});n=-1;k.duration(function(j,q){return r[q?n:++n]});return k};f.on=function(k,n){g[k].add(n);return f};return f.delay(0).duration(250)}function R(a){return typeof a=="function"?function(b,e,f){return l.interpolate(f,a.call(this,b,e))}:function(b,e,f){return l.interpolate(f,a)}}var l=F.d3={};l.version="0.1.0";l.range=function(a,b,e){if(arguments.length==1){b=a;a=0}if(e==null)e=1;if((b-a)/
e==Infinity)throw Error("infinite range");var f=[],c=-1,d;if(e<0)for(;(d=a+e*++c)>b;)f.push(d);else for(;(d=a+e*++c)<b;)f.push(d);return f};l.ns={prefix:{svg:"http://www.w3.org/2000/svg",xhtml:"http://www.w3.org/1999/xhtml",xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"},qualify:function(a){var b=a.indexOf(":");return b<0?a:{space:l.ns.prefix[a.substring(0,b)],local:a.substring(b+1)}}};var ca=G(2),da=G(3),ea={linear:function(){return T},
poly:G,quad:function(){return ca},cubic:function(){return da},sin:function(){return U},exp:function(){return V},circle:function(){return W},elastic:function(a,b){var e;if(arguments.length<2)b=0.45;if(arguments.length<1){a=1;e=b/4}else e=b/(2*Math.PI)*Math.asin(1/a);return function(f){return 1+a*Math.pow(2,10*-f)*Math.sin(-(f+e)*2*Math.PI/b)}},back:function(a){a||(a=1.70158);return function(b){return b*b*((a+1)*b-a)}},bounce:function(){return X}},fa={"in":function(a){return a},out:N,"in-out":O,"out-int":function(a){return O(N(a))}};
l.ease=function(a){var b=a.indexOf("-"),e=b>=0?a.substring(0,b):a;b=b>=0?a.substring(b+1):"in";return fa[b](ea[e].apply(null,Array.prototype.slice.call(arguments,1)))};l.event=null;l.interpolate=function(a,b){if(typeof b=="number")return l.interpolateNumber(+a,b);if(typeof b=="string")return b in B||/^(#|rgb\(|hsl\()/.test(b)?l.interpolateRgb(String(a),b):l.interpolateString(String(a),b);if(b instanceof Array)return l.interpolateArray(a,b);return l.interpolateObject(a,b)};l.interpolateNumber=function(a,
