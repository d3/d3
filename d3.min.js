...
0,h=a.length;b<h;b++)for(var g=a[b],i=0,j=g.length;i<j;i++){var m=g[i];m&&c.call(m,m.__data__,i)}return a};a.attr=function(c,b){function h(){this.removeAttribute(c)}function g(){this.removeAttributeNS(c.space,c.local)}function i(){this.setAttribute(c,b)}function j(){this.setAttributeNS(c.space,c.local,b)}function m(){var r=b.apply(this,arguments);r==o?this.removeAttribute(c):this.setAttribute(c,r)}function p(){var r=b.apply(this,arguments);r==o?this.removeAttributeNS(c.space,c.local):this.setAttributeNS(c.space,
c.local,r)}c=d3.ns.qualify(c);if(arguments.length<2)return f(c.local?function(){return this.getAttributeNS(c.space,c.local)}:function(){return this.getAttribute(c)});return a.each(b==o?c.local?g:h:typeof b=="function"?c.local?p:m:c.local?j:i)};a.style=function(c,b,h){function g(){this.style.removeProperty(c)}function i(){this.style.setProperty(c,b,h)}function j(){var m=b.apply(this,arguments);m==o?this.style.removeProperty(c):this.style.setProperty(c,m,h)}if(arguments.length<3)h=o;if(arguments.length<
