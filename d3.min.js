(function(){var p=null;d3={version:"0.11.0"};if(!Date.now)Date.now=function(){return+new Date};if(!Object.create)Object.create=function(a){function d(){}d.prototype=a;return new d};function z(a){return Array.prototype.slice.call(a)}function C(a,d){d=z(arguments);d[0]=this;a.apply(this,d);return this}d3.range=function(a,d,e){if(arguments.length==1){d=a;a=0}if(e==p)e=1;if((d-a)/e==Infinity)throw Error("infinite range");var f=[],c=-1,b;if(e<0)for(;(b=a+e*++c)>d;)f.push(b);else for(;(b=a+e*++c)<d;)f.push(b);return f};
...
U[0].parentNode=document.documentElement;d3.select=function(a){return typeof a=="string"?U.select(a):T([[a]])};d3.selectAll=function(a){return typeof a=="string"?U.selectAll(a):T([z(a)])};
...
i=0,j=g.length;i<j;i++){var o=g[i];if(o)return c.call(o,o.__data__,i)}return p}a.select=function(c){return d(function(b){return b.querySelector(c)})};a.selectAll=function(c){return e(function(b){return z(b.querySelectorAll(c))})};a.data=function(c,b){function h(n,q){function v(ia){return n.parentNode.appendChild(ia)}var m=0,s=n.length,B=q.length,r=Math.min(s,B),t=Math.max(s,B),w=[],x=[],u=[],y,A;if(b){r={};t=[];var D;A=q.length;for(m=0;m<s;m++){D=b.nodeKey(y=n[m]);if(D in r)u[A++]=n[m];else{r[D]=
y;t.push(D)}}for(m=0;m<B;m++){if(y=r[D=b.dataKey(A=q[m])]){y.__data__=A;w[m]=y;x[m]=u[m]=p}else{x[m]={appendChild:v,__data__:A};w[m]=u[m]=p}delete r[D]}for(m=0;m<s;m++)if(t[m]in r)u[m]=n[m]}else{for(;m<r;m++){y=n[m];A=q[m];if(y){y.__data__=A;w[m]=y;x[m]=u[m]=p}else{x[m]={appendChild:v,__data__:A};w[m]=u[m]=p}}for(;m<B;m++){x[m]={appendChild:v,__data__:q[m]};w[m]=u[m]=p}for(;m<t;m++){u[m]=n[m];x[m]=w[m]=p}}x.parentNode=w.parentNode=u.parentNode=n.parentNode;x.parentData=w.parentData=u.parentData=n.parentData;
o.push(x);k.push(w);l.push(u)}var g=-1,i=a.length,j,o=[],k=[],l=[];if(typeof b=="string")b=ja(b);if(typeof c=="function")for(;++g<i;)h(j=a[g],c.call(j,j.parentData,g));else for(;++g<i;)h(j=a[g],c);g=T(k);g.enter=function(n){return T(o).append(n)};g.exit=function(){return T(l)};return g};a.each=function(c){for(var b=0,h=a.length;b<h;b++)for(var g=a[b],i=0,j=g.length;i<j;i++){var o=g[i];o&&c.call(o,o.__data__,i)}return a};a.attr=function(c,b){function h(){this.removeAttribute(c)}function g(){this.removeAttributeNS(c.space,
c.local)}function i(){this.setAttribute(c,b)}function j(){this.setAttributeNS(c.space,c.local,b)}function o(){var l=b.apply(this,arguments);l==p?this.removeAttribute(c):this.setAttribute(c,l)}function k(){var l=b.apply(this,arguments);l==p?this.removeAttributeNS(c.space,c.local):this.setAttributeNS(c.space,c.local,l)}c=d3.ns.qualify(c);if(arguments.length<2)return f(c.local?function(){return this.getAttributeNS(c.space,c.local)}:function(){return this.getAttribute(c)});return a.each(b==p?c.local?
g:h:typeof b=="function"?c.local?k:o:c.local?j:i)};a.style=function(c,b,h){function g(){this.style.removeProperty(c)}function i(){this.style.setProperty(c,b,h)}function j(){var o=b.apply(this,arguments);o==p?this.style.removeProperty(c):this.style.setProperty(c,o,h)}if(arguments.length<3)h=p;if(arguments.length<2)return f(function(){return window.getComputedStyle(this,p).getPropertyValue(c)});return a.each(b==p?g:typeof b=="function"?j:i)};a.property=function(c,b){function h(){delete this[c]}function g(){this[c]=
b}function i(){var j=b.apply(this,arguments);if(j==p)delete this[c];else this[c]=j}c=d3.ns.qualify(c);if(arguments.length<2)return f(function(){return this[c]});return a.each(b==p?h:typeof b=="function"?i:g)};a.text=function(c){function b(){this.appendChild(document.createTextNode(c))}function h(){var g=c.apply(this,arguments);g!=p&&this.appendChild(document.createTextNode(g))}if(arguments.length<1)return f(function(){return this.textContent});a.each(function(){for(;this.lastChild;)this.removeChild(this.lastChild)});
return c==p?a:a.each(typeof c=="function"?h:b)};a.html=function(c){function b(){this.innerHTML=c}function h(){this.innerHTML=c.apply(this,arguments)}if(arguments.length<1)return f(function(){return this.innerHTML});return a.each(typeof c=="function"?h:b)};a.append=function(c){function b(g){return g.appendChild(document.createElement(c))}function h(g){return g.appendChild(document.createElementNS(c.space,c.local))}c=d3.ns.qualify(c);return d(c.local?h:b)};a.remove=function(){return d(function(c){var b=
c.parentNode;b.removeChild(c);return b})};a.sort=function(c){c=ka.apply(this,arguments);for(var b=0,h=a.length;b<h;b++){var g=a[b];g.sort(c);for(var i=1,j=g.length,o=g[0];i<j;i++){var k=g[i];if(k){o&&o.parentNode.insertBefore(k,o.nextSibling);o=k}}}return a};a.on=function(c,b){c="on"+c;return a.each(function(h,g){this[c]=function(i){d3.event=i;try{b.call(this,h,g)}finally{d3.event=p}}})};a.transition=function(c){return V(a,c)};a.call=C;return a}
function ja(a){return{nodeKey:function(d){return d.getAttribute(a)},dataKey:function(d){return d[a]}}}function ka(a){arguments.length||(a=la);return function(d,e){return a(d&&d.__data__,e&&e.__data__)}}function la(a,d){return a<d?-1:a>d?1:0}d3.transition=U.transition;
function V(a,d){function e(k){var l=true,n=-1;a.each(function(){if(h[++n]!=2){var q=(k-g[n])/i[n];if(q>=1)q=1;else{l=false;if(q<0)return;if(!h[n]){h[n]=1;b.start.dispatch.apply(this,arguments)}}var v=o(q),m;for(m in c)c[m].call(this,v,n);if(q==1){h[n]=2;b.end.dispatch.apply(this,arguments)}}});return l}var f={},c={},b=d3.dispatch("start","end"),h=[],g=[],i=[],j,o=d3.ease("cubic-in-out");f.delay=function(k){var l=Infinity,n=-1;if(typeof k=="function")a.each(function(){var q=g[++n]=+k.apply(this,arguments);
if(q<l)l=q});else{l=+k;a.each(function(){g[++n]=l})}ma(e,l);return f};f.duration=function(k){var l=-1;if(typeof k=="function"){j=0;a.each(function(){var n=i[++l]=+k.apply(this,arguments);if(n>j)j=n})}else{j=+k;a.each(function(){i[++l]=j})}return f};f.ease=function(k){o=typeof k=="string"?d3.ease(k):k;return f};f.attrTween=function(k,l){function n(r,t){s[++B]=l.call(this,r,t,this.getAttribute(k))}function q(r,t){s[++B]=l.call(this,r,t,this.getAttributeNS(k.space,k.local))}function v(r,t){this.setAttribute(k,
s[t](r))}function m(r,t){this.setAttributeNS(k.space,k.local,s[t](r))}var s=[],B=-1;k=d3.ns.qualify(k);a.each(k.local?q:n);c["attr."+k]=k.local?m:v;return f};f.attr=function(k,l){return f.attrTween(k,W(l))};f.styleTween=function(k,l,n){var q=[],v=-1;a.each(function(m,s){q[++v]=l.call(this,m,s,window.getComputedStyle(this,p).getPropertyValue(k))});c["style."+k]=function(m,s){this.style.setProperty(k,q[s](m),n)};return f};f.style=function(k,l,n){return f.styleTween(k,W(l),n)};f.select=function(k){var l;
