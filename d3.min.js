(function(){var o=null;d3={version:"0.28.4"};if(!Date.now)Date.now=function(){return+new Date};if(!Object.create)Object.create=function(a){function b(){}b.prototype=a;return new b};function x(a){return Array.prototype.slice.call(a)}function y(a){return typeof a=="function"?a:function(){return a}}d3.ascending=function(a,b){return a<b?-1:a>b?1:0};d3.descending=function(a,b){return b<a?-1:b>a?1:0};d3.merge=function(a){return Array.prototype.concat.apply([],a)};
d3.split=function(a,b){var c=[],f=[],d,e=-1,h=a.length;if(arguments.length<2)b=aa;for(;++e<h;)if(b.call(f,d=a[e],e)){c.push(f);f=[]}else f.push(d);c.push(f);return c};function aa(a){return a==o}function E(a){return a.replace(/(^\s+)|(\s+$)/g,"").replace(/\s+/g," ")}function ba(a,b){b=x(arguments);b[0]=this;a.apply(this,b);return this}
d3.range=function(a,b,c){if(arguments.length==1){b=a;a=0}if(c==o)c=1;if((b-a)/c==Infinity)throw Error("infinite range");var f=[],d=-1,e;if(c<0)for(;(e=a+c*++d)>b;)f.push(e);else for(;(e=a+c*++d)<b;)f.push(e);return f};d3.requote=function(a){return a.replace(ca,"\\$&")};var ca=/[\\\^\$\*\+\?\[\]\(\)\.\{\}]/g;
...
d3.html=function(a,b){d3.text(a,"text/html",function(c){if(c!=o){var f=document.createRange();f.selectNode(document.body);c=f.createContextualFragment(c)}b(c)})};d3.xml=function(a,b,c){if(arguments.length<3){c=b;b=o}d3.xhr(a,b,function(f){c(f&&f.responseXML)})};
...
d3.interpolateString=function(a,b){var c,f,d=0,e=[],h=[],g,i;for(f=0;c=H.exec(b);++f){c.index&&e.push(b.substring(d,c.index));h.push({a:e.length,x:c[0]});e.push(o);d=H.lastIndex}d<b.length&&e.push(b.substring(d));f=0;for(g=h.length;(c=H.exec(a))&&f<g;++f){i=h[f];if(i.x==c[0]){if(i.a)if(e[i.a+1]==o){e[i.a-1]+=i.x;e.splice(i.a,1);for(c=f+1;c<g;++c)h[c].a--}else{e[i.a-1]+=i.x+e[i.a+1];e.splice(i.a,2);for(c=f+1;c<g;++c)h[c].a-=2}else if(e[i.a+1]==o)e[i.a]=i.x;else{e[i.a]=i.x+e[i.a+1];e.splice(i.a+1,1);
for(c=f+1;c<g;++c)h[c].a--}h.splice(f,1);g--;f--}else i.x=d3.interpolateNumber(parseFloat(c[0]),parseFloat(i.x))}for(;f<g;){i=h.pop();if(e[i.a+1]==o)e[i.a]=i.x;else{e[i.a]=i.x+e[i.a+1];e.splice(i.a+1,1)}g--}if(e.length==1)return e[0]==o?h[0].x:function(){return b};return function(j){for(f=0;f<g;++f)e[(i=h[f]).a]=i.x(j);return e.join("")}};
...
function I(a,b,c){var f,d,e,h,g;if(h=/([a-z]+)\((.*)\)/i.exec(a)){g=h[2].split(",");switch(h[1]){case "hsl":return c(parseFloat(g[0]),parseFloat(g[1])/100,parseFloat(g[2])/100);case "rgb":return b(L(g[0]),L(g[1]),L(g[2]))}}if(c=G[a])return b(c.r,c.g,c.b);if(a==o)return b(0,0,0);if(a.charAt(0)=="#"){if(a.length==4){f=a.charAt(1);f+=f;d=a.charAt(2);d+=d;e=a.charAt(3);e+=e}else if(a.length==7){f=a.substring(1,3);d=a.substring(3,5);e=a.substring(5,7)}f=parseInt(f,16);d=parseInt(d,16);e=parseInt(e,16)}return b(f,
...
function O(a){function b(d){for(var e=[],h,g,i,j,l=0,p=a.length;l<p;l++){i=a[l];e.push(h=[]);h.parentNode=i.parentNode;h.parentData=i.parentData;for(var q=0,k=i.length;q<k;q++)if(j=i[q]){h.push(g=d(j));if(g&&"__data__"in j)g.__data__=j.__data__}else h.push(o)}return O(e)}function c(d){for(var e=[],h,g,i,j=0,l=a.length;j<l;j++){g=a[j];for(var p=0,q=g.length;p<q;p++)if(i=g[p]){e.push(h=d(i));h.parentNode=i;h.parentData=i.__data__}}return O(e)}function f(d){for(var e=0,h=a.length;e<h;e++)for(var g=a[e],
i=0,j=g.length;i<j;i++){var l=g[i];if(l)return d.call(l,l.__data__,i)}return o}a.select=function(d){return b(function(e){return e.querySelector(d)})};a.selectAll=function(d){return c(function(e){return x(e.querySelectorAll(d))})};a.filter=function(d){for(var e=[],h,g,i,j=0,l=a.length;j<l;j++){g=a[j];e.push(h=[]);h.parentNode=g.parentNode;h.parentData=g.parentData;for(var p=0,q=g.length;p<q;p++)if((i=g[p])&&d.call(i,i.__data__,p))h.push(i)}return O(e)};a.data=function(d,e){function h(k,n){function r(Ga){return k.parentNode.appendChild(Ga)}
var m=0,t=k.length,u=n.length,s=Math.min(t,u),v=Math.max(t,u),z=[],A=[],w=[],B,C;if(e){s={};v=[];var D;C=n.length;for(m=0;m<t;m++){D=e.nodeKey(B=k[m]);if(D in s)w[C++]=k[m];else{s[D]=B;v.push(D)}}for(m=0;m<u;m++){if(B=s[D=e.dataKey(C=n[m])]){B.__data__=C;z[m]=B;A[m]=w[m]=o}else{A[m]={appendChild:r,__data__:C};z[m]=w[m]=o}delete s[D]}for(m=0;m<t;m++)if(v[m]in s)w[m]=k[m]}else{for(;m<s;m++){B=k[m];C=n[m];if(B){B.__data__=C;z[m]=B;A[m]=w[m]=o}else{A[m]={appendChild:r,__data__:C};z[m]=w[m]=o}}for(;m<
u;m++){A[m]={appendChild:r,__data__:n[m]};z[m]=w[m]=o}for(;m<v;m++){w[m]=k[m];A[m]=z[m]=o}}A.parentNode=z.parentNode=w.parentNode=k.parentNode;A.parentData=z.parentData=w.parentData=k.parentData;l.push(A);p.push(z);q.push(w)}var g=-1,i=a.length,j,l=[],p=[],q=[];if(typeof e=="string")e=xa(e);if(typeof d=="function")for(;++g<i;)h(j=a[g],d.call(j,j.parentData,g));else for(;++g<i;)h(j=a[g],d);g=O(p);g.enter=function(k){return O(l).append(k)};g.exit=function(){return O(q)};return g};a.each=function(d){for(var e=
0,h=a.length;e<h;e++)for(var g=a[e],i=0,j=g.length;i<j;i++){var l=g[i];l&&d.call(l,l.__data__,i)}return a};a.node=function(){return f(function(){return this})};a.attr=function(d,e){function h(){this.removeAttribute(d)}function g(){this.removeAttributeNS(d.space,d.local)}function i(){this.setAttribute(d,e)}function j(){this.setAttributeNS(d.space,d.local,e)}function l(){var q=e.apply(this,arguments);q==o?this.removeAttribute(d):this.setAttribute(d,q)}function p(){var q=e.apply(this,arguments);q==o?
this.removeAttributeNS(d.space,d.local):this.setAttributeNS(d.space,d.local,q)}d=d3.ns.qualify(d);if(arguments.length<2)return f(d.local?function(){return this.getAttributeNS(d.space,d.local)}:function(){return this.getAttribute(d)});return a.each(e==o?d.local?g:h:typeof e=="function"?d.local?p:l:d.local?j:i)};a.classed=function(d,e){function h(){var l=this.className;j.lastIndex=0;if(!j.test(l))this.className=E(l+" "+d)}function g(){var l=E(this.className.replace(j," "));this.className=l.length?l:
o}function i(){(e.apply(this,arguments)?h:g).call(this)}var j=RegExp("(^|\\s+)"+d3.requote(d)+"(\\s+|$)","g");if(arguments.length<2)return f(function(){j.lastIndex=0;return j.test(this.className)});return a.each(typeof e=="function"?i:e?h:g)};a.style=function(d,e,h){function g(){this.style.removeProperty(d)}function i(){this.style.setProperty(d,e,h)}function j(){var l=e.apply(this,arguments);l==o?this.style.removeProperty(d):this.style.setProperty(d,l,h)}if(arguments.length<3)h=o;if(arguments.length<
2)return f(function(){return window.getComputedStyle(this,o).getPropertyValue(d)});return a.each(e==o?g:typeof e=="function"?j:i)};a.property=function(d,e){function h(){delete this[d]}function g(){this[d]=e}function i(){var j=e.apply(this,arguments);if(j==o)delete this[d];else this[d]=j}d=d3.ns.qualify(d);if(arguments.length<2)return f(function(){return this[d]});return a.each(e==o?h:typeof e=="function"?i:g)};a.text=function(d){function e(){this.appendChild(document.createTextNode(d))}function h(){var g=
d.apply(this,arguments);g!=o&&this.appendChild(document.createTextNode(g))}if(arguments.length<1)return f(function(){return this.textContent});a.each(function(){for(;this.lastChild;)this.removeChild(this.lastChild)});return d==o?a:a.each(typeof d=="function"?h:e)};a.html=function(d){function e(){this.innerHTML=d}function h(){this.innerHTML=d.apply(this,arguments)}if(arguments.length<1)return f(function(){return this.innerHTML});return a.each(typeof d=="function"?h:e)};a.append=function(d){function e(g){return g.appendChild(document.createElement(d))}
...
function Da(){for(var a,b=Date.now(),c=S;c;){a=b-c.j;if(a>c.delay)c.t=c.n(a);c=c.next}a=o;for(b=S;b;)b=b.t?a?a.next=b.next:S=b.next:(a=b).next;a||(U=clearInterval(U))}function Ba(a){return typeof a=="function"?function(b,c,f){return d3.interpolate(f,a.call(this,b,c))}:function(b,c,f){return d3.interpolate(f,a)}}d3.scale={};
d3.scale.linear=function(){function a(j){return i((j-c)*h)}function b(j){var l=Math.min(c,f),p=Math.max(c,f),q=p-l,k=Math.pow(10,Math.floor(Math.log(q/j)/Math.LN10));j=j/(q/k);if(j<=0.15)k*=10;else if(j<=0.35)k*=5;else if(j<=0.75)k*=2;return{start:Math.ceil(l/k)*k,stop:Math.floor(p/k)*k+k*0.5,q:k}}var c=0,f=1,d=0,e=1,h=1/(f-c),g=(f-c)/(e-d),i=d3.interpolate(d,e);a.invert=function(j){return(j-d)*g+c};a.domain=function(j){if(!arguments.length)return[c,f];c=j[0];f=j[1];h=1/(f-c);g=(f-c)/(e-d);return a};
...
"#de9ed6"],Ia=["#3182bd","#6baed6","#9ecae1","#c6dbef","#e6550d","#fd8d3c","#fdae6b","#fdd0a2","#31a354","#74c476","#a1d99b","#c7e9c0","#756bb1","#9e9ac8","#bcbddc","#dadaeb","#636363","#969696","#bdbdbd","#d9d9d9"];
d3.scale.quantile=function(){function a(){for(var h=-1,g=e.length=d.length,i=f.length/g;++h<g;)e[h]=f[~~(h*i)]}function b(h){if(isNaN(h=+h))return NaN;for(var g=0,i=e.length-1;g<=i;){var j=g+i>>1,l=e[j];if(l<h)g=j+1;else if(l>h)i=j-1;else return j}return i<0?0:i}function c(h){return d[b(h)]}var f=[],d=[],e=[];c.domain=function(h){if(!arguments.length)return f;f=h.slice().sort(d3.ascending);a();return c};c.range=function(h){if(!arguments.length)return d;d=h;a();return c};return c};d3.svg={};
d3.svg.arc=function(){function a(e,h){var g=b.call(this,e,h),i=c.call(this,e,h),j=f.call(this,e,h)+V,l=d.call(this,e,h)+V,p=l-j,q=p<Math.PI?"0":"1",k=Math.cos(j);j=Math.sin(j);var n=Math.cos(l);l=Math.sin(l);return p>=2*Math.PI?g?"M0,"+i+"A"+i+","+i+" 0 1,1 0,"+-i+"A"+i+","+i+" 0 1,1 0,"+i+"M0,"+g+"A"+g+","+g+" 0 1,1 0,"+-g+"A"+g+","+g+" 0 1,1 0,"+g+"Z":"M0,"+i+"A"+i+","+i+" 0 1,1 0,"+-i+"A"+i+","+i+" 0 1,1 0,"+i+"Z":g?"M"+i*k+","+i*j+"A"+i+","+i+" 0 "+q+",1 "+i*n+","+i*l+"L"+g*n+","+g*l+"A"+g+","+
