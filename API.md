...
* [*bisector*.center](https://github.com/d3/d3-array/blob/v2.7.0/README.md#bisector_center) - binary search for a value in a sorted array.
...
### [Histograms](https://github.com/d3/d3-array/blob/v2.7.0/README.md#histograms)
