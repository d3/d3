...
* [*projection*.preclip](https://github.com/d3/d3-geo/blob/v2.0.0/README.md#projection.preclip) - set the spherical clipping stream transform.
* [*projection*.postclip](https://github.com/d3/d3-geo/blob/v2.0.0/README.md#projection.postclip) - set the planar clipping stream transform.
