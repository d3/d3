...
* [*adder*.valueOf](https://github.com/d3/d3-array/blob/v3.2.4/README.md#adder_valueOf) - returns a double precision representation of an adder’s value.
...
* [d3.thresholdFreedmanDiaconis](https://github.com/d3/d3-array/blob/v3.2.4/README.md#thresholdFreedmanDiaconis) - the Freedman–Diaconis binning rule.
* [d3.thresholdScott](https://github.com/d3/d3-array/blob/v3.2.4/README.md#thresholdScott) - Scott’s normal reference binning rule.
